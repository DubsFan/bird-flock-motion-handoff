...
import type { LandingZone, Point, Sequence, Style } from "@/lib/flock/types"
...
export const Stage = forwardRef<StageHandle, Props>(function Stage(
  ...
  const draw = useCallback(() => {
    ...
    renderProjectFrame(ctx, tRef.current, seqRef.current, styleRef.current, { w: dims.w, h: dims.h }, durRef.current)
  }, [dims])
  ...
  return (
    ...
    >
      {/* Backdrop */}
      {showBackdrop && backdropDataUrl ? (
        // eslint-disable-next-line @next/next/no-img-element
        <img
          src={backdropDataUrl || "/placeholder.svg"}
          alt="Target site backdrop"
