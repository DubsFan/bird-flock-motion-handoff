...
MASTER="$DIR/three_bird_reversed_high_wingbeat_prores4444.mov"
WEBM="$DIR/three_bird_reversed_high_wingbeat_transparent.webm"
REVIEW="$DIR/three_bird_reversed_high_wingbeat_review.mp4"
