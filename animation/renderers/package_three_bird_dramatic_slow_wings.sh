...
MASTER="$DIR/three_bird_dramatic_slow_wings_prores4444.mov"
WEBM="$DIR/three_bird_dramatic_slow_wings_transparent.webm"
REVIEW="$DIR/three_bird_dramatic_slow_wings_review.mp4"
