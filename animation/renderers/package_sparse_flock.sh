...
MASTER="$DIR/birds-sparse-natural-flight-prores4444.mov"
WEBM="$DIR/birds-sparse-natural-flight-transparent.webm"
PREVIEW="$DIR/birds-sparse-natural-flight-review.mp4"
